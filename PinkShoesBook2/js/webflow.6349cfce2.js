 ...
 */
 ...
 module.exports = function($, _) {
  ...
  function ready() {
    ...
    var story;
    var on_slide = 0;
    var json_data_file = "pink_shoes_2_output.json"
    ...
    $.ajax({
      ...
      function(result){           
            ...
            document.getElementById('audioplayer_source').innerHTML = '<source src=' + audio_path + '/s0_1.mp3 + type="audio/mpeg">'; 
          }
        });
    ...
    $doc.on('click', 'a', function(e) {
      if (e.currentTarget.id == "next_button") {
        ...
        if (e.currentTarget.className == "button-selected") {
          ...
          block_found = true;
          // repeat audio
          $("#audioplayer_source").attr("src", audio_path +"/s" + on_slide + "_" + e.currentTarget.id.split("_")[1] + ".mp3").trigger("play");
        } else {
          ...
          for (var i = 0; i < story[on_slide]['slide'].length; i++) {
            ...
            if (document.getElementById('button_' + block_id).className == "button") {  
              ...
              $("#audioplayer_source").attr("src", audio_path +"/s" + on_slide + "_" + block_id + ".mp3").trigger("play");
              ...
              if (story[on_slide]['slide'][i]['img'].lastIndexOf('http', 0) === 0) {
                document.getElementById('image_container').innerHTML = '<img src="' + story[on_slide]['slide'][i]['img'] + '">';
                 ...
                 document.getElementById('image_container').innerHTML = '<img src="' + image_path + '/' + story[on_slide]['slide'][i]['img'] + '">';
              }
        ...
        if (!block_found) {
          $("#audioplayer_source").attr("src", audio_path +"/s" + on_slide + "_0.mp3").trigger("play");
        }
      }
